                ...
                <Container fluid className="mt-5">
                    <div className="mb-5">
                        ...
                        <Row className="justify-content-center text-center"><Col md={"auto"}>
                            <Link href="/pages/download" passHref><Button size="lg">Скачать</Button></Link>
                        </Col></Row>
                    </div>
                    <Row className="justify-content-center">
                        ...
                        <Col md={3}>
                            ...
                            <p>
                                ...
                                ЛЮБОЙ человек может изучить исходные тексты MoreliaTalk, а если захочет, даже поучаствовать
                                в его разработке или создать свой мессенджер на основе MoreliaTalk.
